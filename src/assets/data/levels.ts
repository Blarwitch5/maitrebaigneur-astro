...
import superBaigneurImg from '../images/niveaux/7_super-baigneurs.jpg';
...
const levels: Level[] = [
  ...
  },
  {
    ...
    hints: ["Mon enfant nage avec les brassards ?", "Mon enfant ne met pas la tête dans l'eau ?"],
  },
  {
    slug: 'petit-baigneur',
    name: 'Petit Baigneur',
  ...
  },
  {
    ...
    hints: ["Je sais nager mais je veux améliorer mes nages, en particulier le crawl ?"],
  },
  {
    slug: 'super-baigneur',
    name: 'Super Baigneur',
    image: {
      path: superBaigneurImg,
      alt: "Jeune femme nageant sous l'eau dans une piscine",
    },
    desc: "Je travaille le perfectionnement du crawl, de la brasse et du dos, ainsi que l'initiation au papillon. L'apprentissage se fait de manière progressive, avec des exercices adaptés à l'âge et au niveau de chacun. L'objectif est de développer la technique, la confiance dans l'eau et l'autonomie du baigneur.",
    hints: ['Objectif 4 nages !'],
  },
  {
    slug: 'adulte',
    name: 'Adulte',
